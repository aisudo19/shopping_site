...
<body>
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-5 mb-3 bg-white border-bottom shadow-sm">
        ...
        <div class="flex-row-reverse">
            ...
            if (isset($_SESSION['login']) == false) {
                echo "管理者でログインされていません。<br>";
                echo '<a href="../staff_login/staff_login.php">管理者ログインする</a><br>';
                exit();
            } else {
    ...
    <div class="container">
        <div class="d-flex flex-row">
            <h3 class="font-weight-normal my-0 mr-md-auto font-weight-normal">ショップ管理トップメニュー</h3>
        </div>
